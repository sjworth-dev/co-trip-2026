# Colorado Road Trip — May 24 to Jun 8, 2026

**Travelers:** Sam, Gigi, Jonah (3 months)
**Fly:** DEN Sun May 24 → home Mon Jun 8 (NOLA)
**Style:** Dolomites-with-a-baby. San Juans focus. 8 bases, 14 nights, mix of boutique / historic / Airbnb / hot-springs cabin. Light hiking with carrier, easy road biking.

**[Driving route on Google Maps →](https://www.google.com/maps/dir/Denver+International+Airport/The+Broadmoor,+Colorado+Springs,+CO/Salida,+CO/Pagosa+Springs,+CO/Durango,+CO/Silverton,+CO/Ouray,+CO/Ridgway,+CO/Redstone,+CO/Carbondale,+CO/Denver+International+Airport,+CO)**
...
## Altitude rules for Jonah

- **Sleep below ~8,000 ft.** All bases pass.
- Day trips up high are usually fine; come back down to sleep.
- **Day-trip-only towns:** Telluride (8,750), Mountain Village (9,500), Silverton (9,300), Crested Butte (8,900), top of Pikes Peak (14,115), top of Independence Pass (12,095).
- Watch for: fussiness, poor feeding, fast/labored breathing, bluish lips. Come down if any.
- **Pre-trip:** confirm plan with pediatrician; ask about acetaminophen dosing for travel.
- Pack a **pulse oximeter** (Owlet sock or finger clip) for peace of mind on higher day trips.

---

## Base 1 — Colorado Springs / Broadmoor (Sun–Mon May 24–25)

**Lodging:** The Broadmoor (locked).

**Pickup at DEN, drive south on I-25 ~1.5h.** Check in, decompress.

**Day 1 (Mon May 25) — Falconry + chill:**
- Morning: **Falconry class at the Broadmoor** (their famous on-property program). Hawks on the glove.
- Lunch on property — **Tavern** at the Broadmoor or **Lake Terrace Dining Room**.
- Afternoon: relax. Walk the lakes, swim, gardens, Cheyenne Mountain views. Stroller around the property.
- Dinner: **Penrose Room** (splurge) or **Summit**.

---

## Drive 1 — Springs → Salida (Tue May 26)

US-24 west through Woodland Park → Hartsel → Buena Vista → Salida (continue 25m south of BV). ~2h 45m. Scenic above-treeline pass.
...
**The play:** Soak the terraces at sunset and again at sunrise. The riverside pools are unreal.

**Easy walk:** Riverwalk along the San Juan + downtown.

**Dinner:** **Riff Raff on the Rio** (riverside, casual) or **Kip's Grill** (Mexican, kid-easy).
...
- Morning hike — pick one (carrier-friendly):
  ...
  - **Animas Mountain Trail** — 3.5 mi loop in town, ~1,200 ft gain, big views.
- Lunch at **James Ranch Grill** (15m north, working ranch with farm-to-table burgers, outdoor seating with mountain views).
...
- Pack up and prep for tomorrow's scenic drive to Ridgway.

**Dinners:** **El Moro Tavern** (cocktails, kid-friendly early), **Ore House** (steakhouse splurge), or **Eolus** (small plates).
...
US-550 north → **Coal Bank Pass** (10,640 ft) → **Molas Pass** (10,910 ft, stunning views) → **Silverton** (lunch — **Avalanche Brewing**, walk Greene Street, 9,300 ft so don't linger) → **Red Mountain Pass** (11,018 ft, the famous mining-country hairpins) → **Ouray** (Switzerland of America) → Ridgway.
...
- Walk **Bear Creek Trail** or **Cornet Falls** (short, dramatic) from town.
...
**Dinners:** **The Adobe Inn**, **Maggie's Kitchen**, **Bon Ton** (St Elmo Hotel, Ouray), **Provisions** (Ridgway, casual).
...
- **Distillery Inn at Marble Distilling** — boutique, ~$250.

**Day 1 — settle in (Sat Jun 6, after arriving from Redstone ~50m):**
- Coffee at **Bonfire**.
- Easy hike: **Hay Park Trail** (Sopris views, lower elevation) — turn around as needed.
- Road bike: **Rio Grande Trail** Carbondale → Basalt — paved, mostly flat, valley views.
- **Penny Hot Springs** at sunset — free, riverside, 15m south on Hwy 133.
- Dinner: **Town** (modern American), **Allegria** (Italian), **Phat Thai**, or **Free Range Kitchen**.

**Day 2 — Aspen + Maroon Bells day trip (Sun Jun 7):**
- **Dawn bike to Maroon Bells (Sam):** drive 35m to Aspen, ride from Aspen Highlands lot up Maroon Creek Road. ~5 mi each way, paved, ~1,200 ft of climb (8,200 → 9,580 ft). **Road is closed to cars before 8am** — empty, silent, alpenglow on the Bells. *The bucket-list CO road-bike experience.* ~2h round trip.
  - Rentals: **Hub of Aspen** or **Aspen Velo** — reserve a road bike the day before.
  - Meanwhile: Gigi + Jonah sleep in. Optional later **Maroon Bells shuttle** (recreation.gov, opens ~30 days out) up to the lake to meet you in Aspen, or breakfast in town.
- Late morning: regroup, breakfast at **Bonnie's** or **Spring Café**.
- Lunch options:
  - **Woody Creek Tavern** in Woody Creek (~250-person hamlet, Hunter S. Thompson's old hangout) — kitschy roadhouse, real character, ridiculous patio.
  - **Meat & Cheese**, **White House Tavern**, or **Hooch** in Aspen.
- Afternoon: drive **Castle Creek Road** to **Ashcroft Ghost Town** (30m south of Aspen, free) — preserved 1880s mining village in a meadow with the Elk Range behind it.
- Wander Aspen, ride the **Silver Queen Gondola** if running, **cocktails at the J-Bar** at Hotel Jerome (CO institution since 1889).
- Drive 35m back to Carbondale to sleep low.
- Dinner: back in Carbondale at **Town** or **Allegria**, or splurge at **Pine Creek Cookhouse** in Ashcroft on the way back (reserve weeks ahead).
...
**Scenic via Independence Pass (~4.5h, recommended if open):**
Hwy 82 east through Aspen → **Independence Ghost Town** (20 min east of Aspen, ~10,900 ft, abandoned 1879 mining settlement, free 15-min walk-around) → **Independence Pass summit (12,095 ft)** — gawk briefly, push down → **Twin Lakes** (one of CO's prettiest reservoirs) → **Leadville** (10,150 ft, coffee at City on a Hill or Periodic Brewing) → Copper Mountain → I-70 east → DEN.

**Direct via I-70 (~3h):**
Hwy 82 north → I-70 east through **Glenwood Canyon**, Vail Pass, Frisco. Lunch at **Beau Jo's** in Idaho Springs (kitschy mountain pizza).

**Caveat:** Independence Pass closes Nov to late May. Should be open by Jun 8 but check **cotrip.org** day-of. Take the scenic option unless your flight is early.

Return rental, fly home.

---

## Reservations to lock NOW (in priority order)

1. **Avalanche Ranch hot-tub cabin** — Jun 5. *Most likely to sell out.*
2. **The Springs Resort, Pagosa** — May 28. Big property but Wed of Memorial weekend run.
3. **Salida hotel** — May 26–27. Two nights now.
4. **Beaumont Hotel, Ouray** — Jun 4 only.
5. **Rochester Hotel, Durango** — May 29–30 (or Animas Valley Airbnb if going that route).
6. **Carbondale lodging** — Jun 6–7. Sopris-view Airbnb.
7. **Mesa Verde timed tickets** — release window is rolling; book once dated.
8. **Maroon Bells shuttle (Aspen)** — opens ~30 days out at recreation.gov.
9. **Pine Creek Cookhouse, Ashcroft** — if doing for Aspen-day dinner, books weeks out.
10. **Durango–Silverton Train** — optional; Million Dollar Hwy is now part of the move day, so the train is purely additive.

## Memorial Day weekend caveat

May 24–25 is Memorial Day weekend (Mon May 25 = Memorial Day). Colorado Springs / Garden of the Gods will be busy. Broadmoor handles it. From Tue May 26 on, the trip is mid-week into a normal week — much quieter.

## Pack list flags (baby-specific)

- Pulse oximeter
- Sun shade for car rear window
- Stroller that handles dirt paths (jogger or all-terrain)
- Carrier (Ergo / Tula) — most hikes here will be carrier, not stroller
- White noise + portable fan
- Extra layers — high-country mornings drop into the 30s in late May
- Sunscreen rated for infants (or just shade + long sleeves)
- A second car seat base if Gigi will drive too

## Things I deliberately cut

- **Boulder** — your call; saves Sun-night drive panic anyway.
- **Glenwood Springs as a base** — you can soak there for half a day from Carbondale.
- **Great Sand Dunes** — your call; nice but doesn't fit the loop and 100°F sand isn't fun with Jonah.
- **Crested Butte sleep** — too high. Could be a stretchy day trip from Gunnison if you really wanted it; not worth shuffling for.
- **Telluride sleep** — too high. Day trip from Dolores covers it.
- **Steamboat / RMNP** — geographically wrong; would shred the schedule.
